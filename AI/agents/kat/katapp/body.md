...
1. Read the workspace index first: `c:\BTR\Camelot\RCL\KatApp\.vscode\Documentation\KatApp.md`.
   - If the workspace index is not available, you can fetch the same patterns from `https://raw.githubusercontent.com/terryaney/Documentation.Camelot/main/KatApp/KatApp.md`
